...
final class AdminSettingsController extends AbstractController
{
    ...
    #[Route('/admin/settings/empty-cache', name: 'app_admin_settings_empty_cache')]
    ...
    #[Route('/admin/settings/mail-template/new', name: 'app_admin_settings_mailtemplate_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/settings/mail-template/{id}/edit', name: 'app_admin_settings_mailtemplate_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/settings/mail-template/{id}/delete', name: 'app_admin_settings_mailtemplate_delete', methods: ['POST'])]
