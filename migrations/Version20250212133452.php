 ...
 */
final class Version20250212133452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidacy (id INT AUTO_INCREMENT NOT NULL, candidate_id INT NOT NULL, election_id INT DEFAULT NULL, candidated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', presentation LONGTEXT NOT NULL, INDEX IDX_D930569D91BD8781 (candidate_id), INDEX IDX_D930569DA708DAFF (election_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE plan (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, yearly NUMERIC(10, 2) NOT NULL, monthly NUMERIC(10, 2) NOT NULL, highlighted TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, plan_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, amount NUMERIC(10, 2) NOT NULL, discount INT NOT NULL, periodicity INT NOT NULL, start_at DATE NOT NULL, end_at DATE DEFAULT NULL, features LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_A3C664D3E899029B (plan_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
