 ...
 */
final class Version20250211132243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidacy (id INT AUTO_INCREMENT NOT NULL, candidate_id INT NOT NULL, election_id INT DEFAULT NULL, candidated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', presentation VARCHAR(255) NOT NULL, INDEX IDX_D930569D91BD8781 (candidate_id), INDEX IDX_D930569DA708DAFF (election_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
